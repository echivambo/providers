...
<body>
<div id="featuredImage" class="column"><img src="http://evidevi.com/img/olgo.png" width="150" alt=""  style="margin: 50px auto 0 auto" /></div>
                            ...
                            <td bgcolor="#F3F3F3" width="100%" style="background-color:#f3f3f3;padding:12px;border-bottom:1px solid #ececec">
                                <table border="0" cellspacing="0" cellpadding="0" style="font-weight:200;width:100%!important;font-family:Helvetica,Arial,sans-serif;min-width:100%!important" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td valign="middle" width="50%" align="right" style="padding:0 0 0 10px"><span style="margin:0;color:#4c4c4c;white-space:normal;display:inline-block;text-decoration:none;font-size:12px;line-height:20px">2018 © Copyright Procurement</span></td>
                                        <td width="1">&nbsp;</td>
                                    </tr>
                                    </tbody>
                                </table>
                                                        ...
                                                        <table border="0" cellspacing="0" cellpadding="0" style="font-weight:200;font-family:Helvetica,Arial,sans-serif" width="100%">
                                                            ...
                                                            <tr>
                                                                <td align="center" width="100%">
                                                                    <h1 style="padding:0;margin:0;color:#ffffff;font-weight:500;font-size:20px;line-height:24px">PSI | MOZ Invitation to auto registration providers</h1>
                                                                </td>
                                                            </tr>
                                                            </tbody>
                                                        </table>
                                                        ...
                                                        <table border="0" cellspacing="0" cellpadding="0" style="font-weight:200;font-family:Helvetica,Arial,sans-serif" width="100%">
                                                            ...
                                                            <tr>
                                                                <td align="center" width="100%" style="padding: 0 15px;text-align: justify;color: rgb(76, 76, 76);font-size: 12px;line-height: 18px;">
                                                                    <h3 style="font-weight: 600; padding: 0px; margin: 0px; font-size: 16px; line-height: 24px; text-align: center;" class="title-color">Hi {{$posts['email']}},</h3>
                                                                    <p style="margin: 20px 0 30px 0;font-size: 13px;text-align: center;">Your registered email-id is:<a style="font-style: italic ;font-size: 15px;">{{$posts['codigo']}}</a>  remember to use a same email on the form,so <br/><b>Copy id and register now</b>!</p>
                                                                    <div style="font-weight: 200; text-align: center; margin: 25px;"><a style="padding:0.6em 1em;border-radius:600px;color:#ffffff;font-size:14px;text-decoration:none;font-weight:bold" class="button-color" href="https://www.psi.evidevi.com/providers/public">Complete</a></div>
                                                                </td>
                                                            </tr>
                                                            </tbody>
                                                        </table>
                                            ...
                                            <tr>
                                                <td align="center" valign="middle" width="100%" style="border-top:1px solid #d9d9d9;padding:12px 0px 20px 0px;text-align:center;color:#4c4c4c;font-weight:200;font-size:12px;line-height:18px">Regards,
                                                    ...
                                                    <br><b><a href="https//evidevi.com" title="Power By">Power By evidevi.com</a><b>
                                                            <br><b title="Power By">adimin@.evidevi.com<b>
